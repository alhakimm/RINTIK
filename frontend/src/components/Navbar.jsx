...
const Navbar = () =>{
    ...
    return(
        ...
        <img className='w-[10%] h-full' src={logo} alt="logo" />
            ...
            <ul className='pr-4 ml-auto'>
                <a className='pr-4 ml-4 no-underline py-2 transition-colors duration-300 hover:text-blue-600' href="#Community">Community</a>
                <a className='pr-4 ml-4 no-underline py-2 transition-colors duration-300 hover:text-blue-600' href="#Education">Education</a>
                <a className='pr-4 ml-4 no-underline py-2 transition-colors duration-300 hover:text-blue-600' href="#Plumber">Plumber</a>
                <a className='pr-4 ml-4 no-underline py-2 transition-colors duration-300 hover:text-blue-600' href="#Map">Map</a>
            </ul>
           {/*REPORT Button*/}
